...
%only extract those values in noise that correspond to sp being greater
%than zero 
...
% this makes the values for "reference" in data to be zero so you have a
% new k with uniform undersampling. 
