...
% step below resizes to 256*256 x 8. 
% LOGIC: 256*256*8/divide by third dimension = 256*256*8/8
%        obtain third dimension by lenght(size(array)) which gets the last
%        dimension and then do size(last dim) which is 8. 
% ALSO: Whole number of elements/ size of third dim, size of third dim.
...
M = size(noise,2);
%outputs covariance matrix (step below):
